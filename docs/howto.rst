...
The sphinx extension `apidoc <https://www.sphinx-doc.org/en/master/usage/extensions/autodoc.html>`_ is used to automatically document code using signatures and docstrings.
